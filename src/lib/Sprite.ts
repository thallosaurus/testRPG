...
// const socket;
export class PlayerEntity extends SocketConnection implements MapObject {
...
/*             ctx.fillStyle = "black";
            ctx.fillRect(x + this.visualOffsetX, y + this.visualOffsetY - 10, this.width, 12);

            ctx.fillStyle = "white";
            ctx.fillText("ID: " + this.id, x + this.visualOffsetX, y + this.visualOffsetY, this.width) */
        }
